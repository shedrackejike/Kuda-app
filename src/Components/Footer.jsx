    ...
    <Box minH={"100%"} w={"90%"} margin={"auto"} >
      ...
      >
        ...
        <Box h={"200px"} w={"170px"} >
          ...
          <Text mt={"2"} fontSize={'13px'}>Discover Personal</Text>
          <Text mt={"2"} fontSize={'13px'}>Transfer & Spend</Text>
          <Text mt={"2"} fontSize={'13px'}>Save</Text>
          <Text mt={"2"} fontSize={'13px'}>Investments</Text>
          <Text mt={"2"} fontSize={'13px'}>Kuda card</Text>
        </Box>
        ...
        <Box h={"200px"} w={"170px"} >
          ...
          <Text mt={"1"} fontSize={'13px'}>Discover Business</Text>
          <Text mt={"1"} fontSize={'13px'}>Business Registration</Text>
          <Text mt={"1"} fontSize={'13px'}>SoftPOS</Text>
          <Text mt={"1"} fontSize={'13px'}>Invoicing</Text>
          <Text mt={"1"} fontSize={'13px'}>Electricity</Text>
        </Box>
        ...
        <Box h={"200px"} w={"170px"} >
          ...
          <Text mt={"1"} fontSize={'13px'}>Blog</Text>
          <Text mt={"1"} fontSize={'13px'}>Press</Text>
          <Text mt={"1"} fontSize={'13px'}>Join Our Team</Text>
          <Text mt={"1"} fontSize={'13px'}>About Us</Text>
        </Box>
        ...
        <Box h={"200px"} w={"170px"} >
          ...
          <Text mt={"1"} fontSize={'13px'}>Get Help</Text>
          <Text mt={"1"} fontSize={'13px'}>Scam Awareness</Text>
          <Text mt={"1"} fontSize={'13px'}>FAQs</Text>
          <Text mt={"1"} fontSize={'13px'}>Security</Text>
          <Text mt={"1"} fontSize={'13px'}>Contact Us</Text>
          <Text mt={"1"} fontSize={'13px'}>Self Help</Text>
        </Box>
        ...
        <Box h={"200px"} w={"170px"} >
          ...
          <Text mt={"1"} fontSize={'13px'}>Terms & Conditions</Text>
          <Text mt={"1"} fontSize={'13px'}>Privacy Policy</Text>
          <Text mt={"1"} fontSize={'13px'}>Information Security Policy</Text>
          <Text mt={"1"} fontSize={'13px'}>Cookie Policy</Text>
        </Box>
      </Flex>
      ...
      <Box h={"50px"} w={"90%"}  margin={"auto"}>
        <Text textAlign={"center" } textColor={'#9E9E9E'}>Products may vary by country or market</Text>
      </Box>

      <Box minH={"100%"} w={"100%"} margin={"auto"} >
        <Flex
          minH={"100px"}
          w={"90%"}
          margin={"auto"}
        ...
        >
          <Box h={"150px"} w={"350px"} >
            ...
            <Link>
              <Text mt={"5"} fontWeight={"bold"} textColor={"#57357F"}>help@kuda.com</Text>
            </Link>
            <Flex
              minH={"50px"}
              w={"350px"}
          ...
          <Box h={"150px"} w={"200px"} >
            ...
            <Text mt={"5"} fontSize={'13px'}>151 Herbert Macaulay Way, Yaba,</Text>
          ...
          <Box h={"150px"} w={"200px"} >
            ...
            <Text mt={"5"} fontSize={'13px'}>5 New Street Square,</Text>
          ...
          <Box h={"150px"} w={"200px"} >
            ...
            <Text mt={"5"} fontSize={'13px'}>146 Campground Road,</Text>
      ...
      <Box minH={"100%"} w={"100%"} margin={"auto"} >
        <Box minH={"300px"} w={"93%"}  margin={"auto"}>
          <Box minH={"70px"} w={"70%"} >
